 ...
 */
UENUM(BlueprintType)
enum class EWeaponPattern : uint8
{
...
struct BORNTOENDURE_API FWeaponModifierData
{
	GENERATED_BODY()
	...
	TSoftClassPtr<AActor> OverrideWeaponClass;

	/**
	 * @brief 추가 발사체 개수
	 */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly)
	int32 WeaponCountAdd = 0;
...
public:
	...
	FWeaponModifierData WeaponModifier;
